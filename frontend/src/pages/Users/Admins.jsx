        ...
        <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                    ...
                    <div className="p-4 md:p-5">
                      <form onSubmit={savAdmin} className="space-y-4" action="#">
                        <div>
                          ...
                          <input type="text" value={adminslidt.name} onChange={hundInput} name="name" id="name" className="outline-none bg-gray-100 border border-blue-300 text-gray-900 text-sm rounded-lg focus:border-blue-600 block w-full p-2.5" />
                          <span className='text-red-500 text-[14px]'>{inputError.name}</span>
                        </div>
                        <div>
                          <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                          <input type="email" value={adminslidt.email} onChange={hundInput} name="email" id="email" className="outline-none bg-gray-50 border border-blue-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                        ...
                        <div>
                          ...
                          <input type="password" value={adminslidt.password} onChange={hundInput} name="password" id="password" className="outline-none bg-gray-50 border border-blue-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
          ...
          <div className="adminComp max-w-full overflow-x-auto">
            <table className="w-full table-auto">
              ...
              <tbody>
                {data.length > 0 ? (data.map((packageItem, key) => (
                  <tr key={key}>
                    ...
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <div className="flex items-center">
                        <button type='button' onClick={(e) => deletemodale(e, packageItem.admin_id)} className="hover:text-primary">
                          <svg
                ...
                ))) : (<tr><td className='p-5 text-red-500 text-center text-[20px]' colspan='4'>Not data found</td></tr>)}
              </tbody>
            </table>
          </div>
        </div>
