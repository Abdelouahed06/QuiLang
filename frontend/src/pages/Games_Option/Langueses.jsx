...
const Langueses = () => {
  const packageData = [{ id: '09823401', Langue: 'Tamazight', Mlang: false, Glang: true },
  { id: '09823401', Langue: 'Arabic', Mlang: true, Glang: true },
  { id: '09823401', Langue: 'French', Mlang: true, Glang: false },
  { id: '09823401', Langue: 'English', Mlang: false, Glang: false },
  { id: '09823401', Langue: 'Korean', Mlang: false, Glang: true }
  ];
                  ...
                  <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="p-4 md:p-5">
                      <form className="space-y-4" action="#">
                        ...
                        <div>
                          <label for="Langue" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Langue</label>
                          <input type="text" name="Langue" id="Langue" className="outline-none bg-gray-100 border border-blue-300 text-gray-900 text-sm rounded-lg focus:border-blue-600 block w-full p-2.5" required />
                        </div>
                              ...
                              >
                                <div className="relative">
                                  <input
                                    ...
                                    className="sr-only"
                                    onChange={() => {
                                      setIsChecked01(!isChecked01);
                                    }}
                                  />
                                  <div
                                    className={`mr-4 flex h-5 w-5 items-center justify-center rounded border ${isChecked01 && 'border-primary bg-gray dark:bg-transparent'
                                      }`}
                                  >
                                    <span className={`opacity-0 ${isChecked01 && '!opacity-100'}`}>
                                      <svg
                                        width="11"
                                        height="8"
                                        viewBox="0 0 11 8"
                              ...
                              >
                                <div className="relative">
                                  <input
                                    ...
                                    className="sr-only"
                                    onChange={() => {
                                      setIsChecked02(!isChecked02);
                                    }}
                                  />
                                  <div
                                    className={`mr-4 flex h-5 w-5 items-center justify-center rounded border ${isChecked02 && 'border-primary bg-gray dark:bg-transparent'
                                      }`}
                                  >
                                    <span className={`opacity-0 ${isChecked02 && '!opacity-100'}`}>
                                      <svg
                                        width="11"
                                        height="8"
                                        viewBox="0 0 11 8"
                  ...
                  <tr key={key}>
                    ...
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <p className="inline-flex rounded-full bg-opacity-10 py-1 px-3 text-sm font-medium">
                        {packageItem.Mlang ? (<p>yes</p>) : (<p>no</p>)}
                      </p>
                    </td>
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <p className="inline-flex rounded-full bg-opacity-10 py-1 px-3 text-sm font-medium">
                        {packageItem.Glang ? (<p>yes</p>) : (<p>no</p>)}
                      </p>
                    </td>
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
