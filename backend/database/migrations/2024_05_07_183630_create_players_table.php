...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('players', function (Blueprint $table) {
            ...
            $table->unsignedInteger('nlang_id');
            $table->unsignedInteger('glang_id');
            ...
            $table->foreign('nlang_id')->references('lang_id')->on('languages')->onDelete('cascade');
            $table->foreign('glang_id')->references('lang_id')->on('languages')->onDelete('cascade');
            $table->timestamps();
        });
    }
